export const PerfilIcon = ({onclick}) => {
  return (
...
export const CarritoIcon = ({onclick}) => {
  return (
...
export const IconCarritoCardRemove = () => {
  return(
...
export const DeleteItemsCart = ({onclick}) => {
  return (
